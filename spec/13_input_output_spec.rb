...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    subject(:game_wrong) { described_class.new(5, '6') }

    context 'when user guess is not correct' do
      # remove the 'x' before running this test
      it 'is not game over' do
        expect(game_wrong).not_to be_game_over
      end
    end
  end
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        user_input = 's'
        expect(game_check.verify_input(user_input)).to eq(nil)
      end
    end
  end
  ...
  describe '#final_message' do
    ...
    # @guess, and @count
    subject(:game) { described_class.new(6, '6', 3) }
    ...
    context 'when count is 4 and over' do
      # remove the 'x' before running this test
      subject(:game) { described_class.new(9, '9', 5) }
